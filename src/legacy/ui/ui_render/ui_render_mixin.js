    ...
    async handler(request, h) {
      ...
      const darkMode =
        !authEnabled || request.auth.isAuthenticated
          ...
          : uiSettings.getDefault('theme:darkMode');
      ...
      const styleSheetPaths = [
        ...
        themeVersion === 'v7'
          ? `${regularBundlePath}/osd-ui-shared-deps/${UiSharedDeps.cssDistFilename}`
          : `${regularBundlePath}/osd-ui-shared-deps/${UiSharedDeps.cssV8CssDistFilename}`,
        `${basePath}/node_modules/@osd/ui-framework/dist/kui.css`,
        `${basePath}/ui/legacy_theme.css`,
      ];
