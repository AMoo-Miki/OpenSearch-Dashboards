...
function IndexPatternSelectFormRowUi(props: IndexPatternSelectFormRowUiProps) {
  const { dashLinkIndex, indexPatternId, intl, onChange } = props;
  ...
  return (
    <EuiFormRow
      ...
      label={intl.formatMessage({
        id: 'dashLinks.editor.indexPatternSelect.patternLabel',
        defaultMessage: 'Index Pattern',
      })}
    >
      <props.IndexPatternSelect
        placeholder={intl.formatMessage({
          id: 'dashLinks.editor.indexPatternSelect.patternPlaceholder',
