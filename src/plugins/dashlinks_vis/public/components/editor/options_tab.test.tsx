...
describe('OptionsTab', () => {
  ...
  it('should update updateFiltersOnChange', () => {
    ...
    const checkbox = component.find(
      '[data-test-subj="dashLinksEditorUpdateFiltersOnChangeCheckbox"] button'
    );
  ...
  it('should update useTimeFilter', () => {
    const component = mountWithIntl(<OptionsTab {...props} />);
    const checkbox = component.find(
      '[data-test-subj="dashLinksEditorUseTimeFilterCheckbox"] button'
    );
    checkbox.simulate('click');
  ...
  it('should update pinFilters', () => {
    const component = mountWithIntl(<OptionsTab {...props} />);
    const checkbox = component.find('[data-test-subj="dashLinksEditorPinFiltersCheckbox"] button');
    checkbox.simulate('click');
