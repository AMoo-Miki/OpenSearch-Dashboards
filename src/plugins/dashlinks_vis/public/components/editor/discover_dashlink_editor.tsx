...
interface DiscoverDashLinkEditorProps {
...
interface DiscoverDashLinkEditorState {
  IndexPatternSelect: ComponentType<IndexPatternSelectProps> | null;
}

export class DiscoverDashLinkEditor extends PureComponent<
  DiscoverDashLinkEditorProps,
  DiscoverDashLinkEditorState
> {
  state: DiscoverDashLinkEditorState = {
