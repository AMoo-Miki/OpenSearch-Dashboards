...
export type ThemeTag = 'v7light' | 'v7dark' | 'v8light' | 'v8dark' | 'v7' | 'v8';
export const DEFAULT_THEMES = tags('v7light', 'v7dark', 'v8light', 'v8dark', 'v7', 'v8');
export const ALL_THEMES = tags('v7light', 'v7dark', 'v8light', 'v8dark', 'v7', 'v8');
